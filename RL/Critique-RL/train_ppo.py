...
from data.prompts_dataset import PromptDataset
...
def train(args):
    import time
    print("-----------------------------Start training Critique RL--------------------------")
    # time.sleep(10000)
    # configure strategy
    ...
    prompts_dataset = PromptDataset(prompts_data, strategy, task_type="critique")
...
if __name__ == "__main__":
    ...
    # For RL-Critique
    parser.add_argument("--actor_template", type=str, default="llama3")
    parser.add_argument("--critique_template", type=str, default="llama3")
    parser.add_argument("--ppo_dataset_type", nargs='+', default=["math"])
    parser.add_argument("--actor_model", type=str, default=None, help="The Actor Model in the reasoning task.")
    parser.add_argument("--discrimination_only_step", type=int, default=200, help="steps to train discrimination ability(Critique-RL stage1)")
